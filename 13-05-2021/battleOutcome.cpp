int battleOutcome(int num) {
	 /*First we convert the num integer to string ,Its very useful to iterate index wise*/
	 ...
	 {  
	        /*if numStr[i] and numStr[i+1]  values are different we find the big value and add it to the battleOut string*/
